...
DATABASES = {
    'default': {
        'ENGINE': os.getenv('DATABASE_ENGINE', os.getenv('DB_ENGINE', 'django.db.backends.postgresql')),
        'NAME': os.getenv('DATABASE_NAME', os.getenv('DB_NAME', 'users')),
        'USER': os.getenv('DATABASE_USERNAME', os.getenv('DB_USER', '')),
